...
public class Main {
    ...
    public static void merge(
            int[] a, int[] l, int[] r, int left, int right) {  // Метод сортирует и собирает по частям

        // Счётчики индексов для массивов.
        // По мере прохождения операций счётчик накапливает значения, перебирая массивы
        int i = 0,      // Левый[]
            j = 0,      // Правый[]
            k = 0;      // Основной[]
